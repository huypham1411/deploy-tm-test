...
const bgImgProfile = require("../assets/slider1_ooniag.webp");
        ...
        <div className="container">
          <div className="user-img">
            <img
              ...
              src={
                this.state.avatar
                  ? this.state.avatar
                  : "https://i.pinimg.com/564x/fd/0c/55/fd0c559856ca991e9e28937dc802f0b0.jpg"
              }
            />
            {!this.state.role && (
              <input
          ...
          <div className="user-profile">
            ...
            <div className="update_btn">
              <button className="btn-ok" onClick={this.update}>
                Update
              </button>
            </div>
            ...
            <div className="orderHis">
              <h1>Order history:</h1>
              <button className="hisBtn" onClick={() => this.clickShowHis()}>
                Click me to show
              </button>
              {this.state.history
                ? this.state.history.map((x, key) => {
                    let cdate = new Date(x.dateOfPurchase).toString();
                    return this.state.showHis ? (
                      <ul key={key}>
